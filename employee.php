...
#row{
 ...
 <form action="" method="post">
    ...
    <div class="ali">
      ...
      <input type="text" name="emp_name" class="input_text" placeholder="Employee Name" autocomplete="off" required="true">
     ...
     <label style="color:white;font-size: 20px;padding: 5px;margin-left: 10%;">Address</label><br>
      <input type="text" name="address" class="input_text" placeholder="Address" autocomplete="off" required="true">
      ...
      <select class="input_text" name="section" required="true">
        ...
        <option value=""> Select a Section Employee</option>
